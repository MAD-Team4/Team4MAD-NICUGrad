...
//   const handleSaveMedication = async (med) => {
//     try {
//       const response = await fetch(`${BASE_URL}/medication`, {
//         method: 'POST',
...
export default function MedicationPage() {
  ...
  const BASE_URL = 'https://nicu-grad-api.onrender.com';
